...
setup_pager(Config, Mode, Cols, Messages, Info, !IO) :-
    ...
    Info = pager_info(Tree, Counter, Scrollable, Extents, Config, History).
...
setup_pager_for_staging(Config, Cols, Text, TextAlt, RetainPagerPos,
    ...
    init_common_history(Config, History),
    Info0 = pager_info(Tree, Counter, Scrollable0, Extents0, Config, History),
    (
        ...
        ;
            ...
            ->
                ...
                toggle_content(ToggleType, NumRows, Cols, MessageUpdate,
                    !Info, !IO)
            ;
                Action = Action0, MessageUpdate = clear_message
            )
        )
    ;
        Action = continue,
